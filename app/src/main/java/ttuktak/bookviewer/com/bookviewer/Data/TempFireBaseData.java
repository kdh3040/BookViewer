    ...
    public TempFireBaseData()
    {
       ...
       // for(int index = 1 ; index <= 4 ; ++index)
        for(int index = 1 ; index <= 2 ; ++index)
        {
            ...
            {
                case 1:
                    curriculumDataata.curriculumName = "학교별 커리큘럼";
                    break;
                case 2:
        ...
        // TODO 빼야댐
        String[] strBookName = {"H팩터의 심리학", "H팩터의 심리학", "프로테스탄티즘의 윤리와 자본주의 정신"};
        ...
        for(int index = 1 ; index <= 2 ; index++)
        {
            ...
            bookData.bookName = strBookName[index];
            bookData.bookAuthor = null; //CommonFunc.getInstance().randomFullName();
            if(index <= 10)
            {
