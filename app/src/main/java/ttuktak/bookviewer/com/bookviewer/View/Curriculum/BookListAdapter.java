...
import ttuktak.bookviewer.com.bookviewer.ViewActivity;
...
public class BookListAdapter extends RecyclerView.Adapter<BookListViewHolder>
{
    ...
    public void onBindViewHolder(BookListViewHolder holder, final int position) {
        ...
        else
        {
            ...
            // TODO 빼야댐
            String[] strBookTime = {"~ 2019-04-01", "~ 2019-04-25", "~ 2019-05-27", "~ 2019-05-20", "~ 2019-05-11", "~ 2019-05-5", "~ 2019-05-30" };
            ...
            public void onClick(View view) {
                ...
                try {
                    ...
                    else
                    {
                        ...
                        intent.putExtra("Path", AppContext.getAssets().list("Data")[position]);
